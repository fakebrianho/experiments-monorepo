...
function theatre() {
	...
	const myFBO = sheet.object('Torus Knot', {
		...
		scale: types.compound({
			x: types.number(fbo.particles.scale.x, { range: [0, 5] }),
			y: types.number(fbo.particles.scale.y, { range: [0, 5] }),
			z: types.number(fbo.particles.scale.z, { range: [0, 5] }),
		}),
		rotation: types.compound({
			x: types.number(fbo.particles.rotation.x, { range: [0, 5] }),
			y: types.number(fbo.particles.rotation.y, { range: [0, 5] }),
			z: types.number(fbo.particles.rotation.z, { range: [0, 5] }),
		}),
	})
