...
function animate() {
	...
	// console.log(Math.abs(Math.sin(time)) + )
	group.scale.x = Math.abs(Math.sin(time * 0.3)) + 0.5
	group.scale.y = Math.abs(Math.sin(time * 0.3)) + 0.5
	group.scale.z = Math.abs(Math.sin(time * 0.3)) + 0.5
