...
function animate() {
	...
	if (scene.children[2]) {
		// console.log((scene.children[2].scale *= Math.abs(Math.sin(time) * 2)))
		// scene.children[2].scale.x *= Math.abs(Math.sin(time) * 1.2)
		// scene.children[2].scale.y *= Math.abs(Math.sin(time) * 1.2)
		// scene.children[2].scale.z *= Math.abs(Math.sin(time) * 1.2)
	}
